import { SupportedChainId } from "../../config/src/chains";

export const ETH_ADDRESS = "0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE";
export const EXTENSIBLE_FALLBACK_HANDLER =
...
export const ALL_SUPPORTED_CHAIN_IDS: SupportedChainId[] = Object.values(
  SupportedChainId
).filter((chainId) => typeof chainId === "number") as SupportedChainId[];
 ...
 */
export const COW_PROTOCOL_SETTLEMENT_CONTRACT_ADDRESS =
 ...
 */
export const COW_PROTOCOL_VAULT_RELAYER_ADDRESS =
 ...
 */
export const EXTENSIBLE_FALLBACK_HANDLER_CONTRACT_ADDRESS =
  mapAddressToSupportedNetworks(EXTENSIBLE_FALLBACK_HANDLER);

/**
 * An object containing the addresses of the `ComposableCow` contracts for each supported chain.
 */
export const COMPOSABLE_COW_CONTRACT_ADDRESS =
  mapAddressToSupportedNetworks(COMPOSABLE_COW);
